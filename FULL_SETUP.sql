-- ============================================================
-- التوحيد — إعداد قاعدة البيانات الكامل (شغّله مرة واحدة في SQL Editor)
-- ============================================================
...
-- ===== create_car_maintenance_schema.sql =====
...
-- ===== add_card_number_to_customers.sql =====
-- ============================================================
...
-- ===== update_deleted_invoices_schema.sql =====
...
-- ===== update_employee_leaves_schema.sql =====
...
-- ===== update_employee_status_schema.sql =====
...
-- ===== update_employees_deductions.sql =====
...
-- ===== update_employees_phone.sql =====
-- إضافة رقم الهاتف لجدول الموظفين
alter table employees add column if not exists phone text;


-- ===== update_finance_schema.sql =====
-- ============================================================
...
-- ===== update_refunded_amount_schema.sql =====
